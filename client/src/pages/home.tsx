        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 py-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8">
            <div className="metric-card fade-in" style={{ animationDelay: '0ms' }}>
              ...
              <p className="text-4xl font-bold tabular-nums">{activeProjects.length}</p>
            ...
            <div className="metric-card metric-card-success fade-in" style={{ animationDelay: '50ms' }}>
              ...
              <p className="text-4xl font-bold tabular-nums text-emerald-400">{onTrackCount}</p>
            ...
            <div className="metric-card metric-card-warning fade-in" style={{ animationDelay: '100ms' }}>
              <div className="flex items-center justify-between mb-3">
                ...
                <span className="text-xs text-amber-400 font-medium">Monitor</span>
              </div>
              <p className="text-4xl font-bold tabular-nums text-amber-400">{atRiskCount}</p>
            ...
            <div className={`metric-card metric-card-danger fade-in ${criticalCount > 0 ? 'pulse-critical' : ''}`} style={{ animationDelay: '150ms' }}>
              ...
              <p className="text-4xl font-bold tabular-nums text-rose-400">{criticalCount}</p>
